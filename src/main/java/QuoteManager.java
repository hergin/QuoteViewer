...
public class QuoteManager {
    ...
    public Quote addQuote(Quote quote) {
        ...
        try {
            ...
            throw new QuoteException("Something went wrong with adding quote", e);
        }
    }
    ...
    public List<Quote> getAllQuotes() {
        // TODO
        try {
            List<Quote> allQuotesList = quoteDao.queryForAll();
    ...
    public Quote updateQuoteFrom(int id, String from) {
        ...
        try {
            ...
            throw new QuoteException("Something happened when updating from", e);
        }
    }
    ...
    public Quote deleteQuote(int id) {
        ...
        try {
            ...
            throw new QuoteException("Something happened when deleting", e);
        }
    }
